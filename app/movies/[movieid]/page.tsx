...
const MovieDetailsPage = async ({
  ...
  const isCollection = movieDetalis.belongs_to_collection && movieDetalis.belongs_to_collection.id 

  const [Similar] = await Promise.all([
    getSimilar(movieDetalis.id, "movie")]);
 const Collection = isCollection !== null || undefined ? await getCollection(JSON.stringify(isCollection)) : null 
